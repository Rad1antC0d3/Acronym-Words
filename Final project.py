...
print("So firstly start with, what are acronym words - ")
print("An acronym is a short form of a word created by long words or phrases such as NLP for natural language processing")
